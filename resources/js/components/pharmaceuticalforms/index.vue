          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">جدول الشكل الصيدلية </h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tr v-for="category in pharmaceuticalforms.data " :key="category.id">
                  <td>{{category.id}}</td>
                  <td>{{category.name}}</td>
              ...
              <!-- /.card-body -->
                ...
                <div class="card-footer">
                    <pagination :data="pharmaceuticalforms"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input v-model="form.name" type="text" name="name"  placeholder="الاسم "
...
<script>
    export default {
        ...
        methods:{
            ...
            updateCategory(id){
                this.$Progress.start()
              this.form.put('api/admin/pharmaceuticalforms/'+this.form.id)
                .then(()=>{
            ...
            deleteUser(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('api/admin/pharmaceuticalforms/'+id).then(()=>{
                            Swal.fire(
                                'Deleted!',
            ...
            getResults(page=1){
              axios.get('api/admin/pharmaceuticalforms?page='+page)
              .then(response=>{
                  this.pharmaceuticalforms=response.data
              })
            },
          createCategory(){
              this.$Progress.start();
              this.form.post('api/admin/pharmaceuticalforms')
              .then(()=>{
        ...
        created() {
            ...
            Fire.$on("Searching",()=>{
                ...
                .then((data)=>{
                    this.pharmaceuticalforms=data.data
                })
                .catch(()=>{
            ...
            // setInterval(()=>this.loadpharmaceuticalforms(),3000)
            //this.$Progress.finish();
        },
        //
        // mounted() {
