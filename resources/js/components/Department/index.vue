          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">جدول اقسام </h3>
                ...
                <table class="table table-hover">
                  ...
                  <td>
                    <div class="widget-user-image">
                        <img class="img-circle"  height="60" :src="'icon/Medicinesections/'+category.icon" alt="User Avatar">
                    </div>
                  </td>
                  <td>
...
<script>
    export default {
        ...
        methods:{
            changeActive(id){
                this.$Progress.start()
                axios.get('api/admin/medicinesections/'+id+'/operation')
                .then(({data})=>{
                    if(data.activated)
            ...
            loadCategories(){
                ...
                axios.get('api/admin/medicinesections?admin=admin')
                .then(({data})=>{
            ...
            updateCategory(id){
                this.$Progress.start()
              this.form.put('api/admin/medicinesections/'+this.form.id)
                .then(()=>{
            ...
            deleteUser(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('api/admin/medicinesections/'+id).then(()=>{
                            Swal.fire(
                                'Deleted!',
            ...
            getResults(page=1){
              axios.get('api/admin/medicinesections?admin=admin&page='+page)
              .then(response=>{
          ...
          createCategory(){
              this.$Progress.start();
              this.form.post('api/admin/medicinesections')
              .then(()=>{
