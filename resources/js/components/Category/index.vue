                ...
                <table class="table table-hover">
                  ...
                  <td>
                    <div class="widget-user-image">
                        <img class="img-circle" height="60" :src="'icon/Categories/'+category.icon" alt="User Avatar">
                    </div>
                  </td>
                 <td>
                        <v-switch
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input v-model="form.name" type="text" name="name"  placeholder="اسم القسم "
...
<script>
    export default {
        ...
        methods:{
            ...
            changeActive(id){
                this.$Progress.start()
                axios.get('api/admin/categories/'+id+'/operation')
                .then(({data})=>{
                    if(data.activated)
            ...
            loadCategories(){
                ...
                axios.get('api/admin/categories?admin=admin')
                .then(({data})=>{
            ...
            deleteUser(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('api/admin/categories/'+id).then(()=>{
                            Swal.fire(
                                'Deleted!',
            ...
            getResults(page=1){
              axios.get('api/admin/categories?admin=admin&page='+page)
              .then(response=>{
