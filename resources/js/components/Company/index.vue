          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">جدول الشركات</h3>
                 ...
                 <td>
                  ...
                  <td>
                    <div class="widget-user-image">
                        <img class="img-circle" height="60" :src="'icon/companies/'+category.logo" alt="User Avatar">
                    </div>
                  </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"  v-show="!editeMode" id="exampleModalLabel">اضافة شركة</h5>
          <h5 class="modal-title" v-show="editeMode" id="updateModaleTitle">تعديل بيانات الشركة</h5>
...
<script>
    export default {
        ...
        methods:{
            changeActive(id){
                this.$Progress.start()
                axios.get('api/admin/companies/'+id+'/operation')
                .then(({data})=>{
                    if(data.activated)
            ...
            loadCategories(){
                ...
                axios.get('api/admin/companies?admin=admin')
                .then(({data})=>{
            ...
            updateCategory(id){
                this.$Progress.start()
              this.form.put('api/admin/companies/'+this.form.id)
                .then(()=>{
            ...
            deleteUser(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('api/admin/companies/'+id).then(()=>{
                            Swal.fire(
                                'Deleted!',
            ...
            getResults(page=1){
              axios.get('api/admin/companies?admin=admin&page='+page)
              .then(response=>{
